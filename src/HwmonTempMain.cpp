...
static constexpr std::array<const char*, 12> sensorTypes = {
...
int main()
{
    ...
    auto ifaceRemovedMatch = std::make_unique<sdbusplus::bus::match::match>(
        ...
        "type='signal',member='InterfacesRemoved',arg0path='" +
            std::string(inventoryPath) + "/'", // object path "/xyz/openbmc_project/inventory/system/board/ICT_NF_Card/NF_card_13"
